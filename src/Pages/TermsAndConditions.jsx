    ...
    <div className="terms-container">
      <div className="terms-content">
        ...
        <section className="terms-section">
          ...
          <p>
            Welcome to Green Bunch Group ("Company", "we", "our", "us")!
            These Terms of Service govern your use of our website located at https://legaladder.in/
            operated by Green Bunch Group.
          </p>
          <p>
          ...
          <p>
            ...
            but please let us know by emailing at contact@legaladder.in so we can try to find a solution.
        ...
        <section className="terms-section">
          <h2>6. Content</h2>
          <p>
            Content found on or through this Service are the property of Green Bunch Group or used
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            are and will remain the exclusive property of Green Bunch Group and its licensors.
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            submit your claim via email to contact@legalladder.in, with the subject line: "Copyright
        ...
        <section className="terms-section">
          ...
          <p>You can contact our Copyright Agent via email at contact@legaladder.in.</p>
        </section>

        <section className="terms-section">
          <h2>13. Error Reporting and Feedback</h2>
          <p>
            You may provide us either directly at contact@legalladder.in or via third party sites and tools
            ...
            and agree that: (i) you shall not retain, acquire or assert any intellectual property right or other
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            controlled by Green Bunch Group.
          </p>
          <p>
            Green Bunch Group has no control over, and assumes no responsibility for the content,
